...
public class BigBUnwarpper implements Runnable {
	...
	public void run() {
		...
		try {
			...
			int resolutionLevel = BigImageUtil.getResolutionLevel(srcFile, new Dimension(1000, 1000));
			BigImageImporter importer = new BigImageImporter(srcFile, resolutionLevel, null);
