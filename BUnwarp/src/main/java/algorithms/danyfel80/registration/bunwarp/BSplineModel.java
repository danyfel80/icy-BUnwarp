...
public class BSplineModel extends Thread {
	...
	public void run() {
		super.run();
		if (image == null && ibi != null) {
			// Original image
			this.originalImage = new double[width * height];
			this.originalHeight = this.height;
			this.originalWidth = this.width;

			MiscTools.extractImage(ibi, this.originalImage);
		...
		if (isTarget || this.isSubsampledOutput)
			buildImagePyramid();
	}
